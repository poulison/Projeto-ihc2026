...
|---|---|---|---|
| Previsão de demanda | Combina métodos estatísticos, ML, IA e sinais internos ou externos para estimar a demanda | <img src="assets/02_concorrencia/blue_yonder_previsao.jpg" alt="Tela Forecast Explainability do Blue Yonder, com previsão e fatores causais por período" width="280"> | A automação reduz trabalho repetitivo, mas a origem e a atualização dos dados precisam estar visíveis para gerar confiança |
...
| Alertas e recomendações | A experiência pública destaca acontecimentos, riscos, indicadores e ações possíveis | <img src="assets/02_concorrencia/blue_yonder_alertas.jpg" alt="Painel do Blue Yonder com tarefas, risco de demanda, previsões e indicadores" width="280"> | O encadeamento “o que aconteceu → por que importa → o que fazer” reduz a distância entre informação e ação |
...
| Funcionalidade | Como é realizada | Evidência/print | Observação de IHC |
|---|---|---|---|
| Painel de exceções | Resume indicadores e prioriza produtos com risco de ruptura, excesso ou outros desvios | <img src="assets/02_concorrencia/netstock_interface.png" alt="Painel de estoque do Netstock com fill rate, excesso e riscos de ruptura" width="280"> | Direciona a atenção, mas o motivo da prioridade precisa estar explícito |
